...
// module
exports.push([module.i, ":host{display:inline-block;background-color:#fff;-moz-box-shadow:0 8px 12px rgba(0,0,0,.2);-webkit-box-shadow:0 8px 12px rgba(0,0,0,.2);box-shadow:0 8px 12px rgba(0,0,0,.2);vertical-align:top;min-width:250px;width:30%;max-width:700px;margin-bottom:20px}:host(.border-gray){border:2px solid #767676}:host(.border-navy){border:2px solid #002e5d}:host(.border-small){border-radius:10px}:host(.border-small) #card-content ::slotted(:first-of-type(.image)){border-top-left-radius:7px;border-top-right-radius:7px}:host(.border-small) #card-content ::slotted(:last-of-type(.image)){border-bottom-left-radius:7px;border-bottom-right-radius:7px}:host(.border-large){border-radius:25px}:host(.border-large) #card-content ::slotted(:first-of-type(.image)){border-top-left-radius:22px;border-top-right-radius:22px}:host(.border-large) #card-content ::slotted(:last-of-type(.image)){border-bottom-left-radius:22px;border-bottom-right-radius:22px}:host(:hover){-moz-box-shadow:0 10px 18px 0 rgba(0,0,0,.3);-webkit-box-shadow:0 10px 18px 0 rgba(0,0,0,.3);box-shadow:0 10px 18px 0 rgba(0,0,0,.3)}:host ul{margin-bottom:0!important}#card-content ::slotted(*){width:100%;box-sizing:border-box;padding:0 20px!important;color:#444}#card-content ::slotted(ul){padding-left:40px!important}#card-content ::slotted(.image),#card-content ::slotted(img){padding:0!important}#card-content ::slotted(:first-of-type(:not(img))){padding-top:20px!important}", ""]);
